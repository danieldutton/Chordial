...
namespace Chordial.UnitTests.Luthier
{
    ...
    {
        private GuitarBuilder _sut;

        [SetUp]
        public void Init()
        {
            _sut = new GuitarBuilder();   
        }

        [Test]
        [ExpectedException(typeof(ArgumentOutOfRangeException))]
        public void GetInstrument_ThrowArgumentOutOfRangeEx_IfStringsLessThan1()
        {
            _sut.GetInstrument(strings: 0);
        }

        [Test]
        [ExpectedException(typeof(ArgumentOutOfRangeException))]
        public void GetInstrument_ThrowArgumentOutOfRangeEx_IfFretsLessThan1()
        {
            _sut.GetInstrument(frets: 0);
        }

        [Test]
        public void GetInstrument_WithSixStringsByDefault()
        {
            Note[,] fretBoard = _sut.GetInstrument();

            Assert.AreEqual(6, fretBoard.GetLength(0));
        }

        [Test]
        public void GetInstrument_WithTwentyFourFretsByDefault()
        {
            Note[,] fretBoard = _sut.GetInstrument();
        ...
        [Test]
        public void GetInstrument_WithFourStrings()
        {
            Note[,] fretBoard = _sut.GetInstrument(strings: 6, frets: 20);

            Assert.AreEqual(6, fretBoard.GetLength(0));
        }

        [Test]
        public void GetInstrument_WithSixStrings()
        {
            Note[,] fretBoard = _sut.GetInstrument(strings: 6, frets: 20);
        ...
        [Test]
        public void GetInstrument_WithTwelveStrings()
        {
            Note[,] fretBoard = _sut.GetInstrument(strings: 6, frets: 20);
        ...
        [Test]
        public void GetInstrument_With21FretSpaces()
        {
            Note[,] fretBoard = _sut.GetInstrument(strings: 6, frets: 10);

            Assert.AreEqual(10, fretBoard.GetLength(1));
        }

        [Test]
        public void GetInstrument_AllInstancesAreOfType_Note()
        {
            Note[] fretBoard = _sut.GetInstrument(strings:6, frets: 10)
                .Cast<Note>()
                .ToArray();
        ...
        [Test]
        public void GetInstrument_InitNoteFretPositionPropertiesCorrectly_0_0()
        {
            Note[,] result = _sut.GetInstrument(strings: 6, frets: 5);
        ...
        [Test]
        public void GetInstrument_InitNoteFretPositionPropertiesCorrectly_0_1()
        {
            Note[,] result = _sut.GetInstrument(strings: 6, frets: 5);
        ...
        [Test]
        public void GetInstrument_InitNoteFretPositionPropertiesCorrectly_0_2()
        {
            Note[,] result = _sut.GetInstrument(strings: 6, frets: 5);
        ...
        [Test]
        public void GetInstrument_InitNoteFretPositionPropertiesCorrectly_0_3()
        {
            Note[,] result = _sut.GetInstrument(strings: 6, frets: 5);
        ...
        [Test]
        public void GetInstrument_InitNoteFretPositionPropertiesCorrectly_0_4()
        {
            Note[,] result = _sut.GetInstrument(strings: 6, frets: 5);
        ...
        [Test]
        public void GetInstrument_InitNoteFretPositionPropertiesCorrectly_1_0()
        {
            Note[,] result = _sut.GetInstrument(strings: 6, frets: 5);
        ...
        [Test]
        public void GetInstrument_InitNoteFretPositionPropertiesCorrectly_1_1()
        {
            Note[,] result = _sut.GetInstrument(strings: 6, frets: 5);
        ...
        [Test]
        public void GetInstrument_InitNoteFretPositionPropertiesCorrectly_1_2()
        {
            Note[,] result = _sut.GetInstrument(strings: 6, frets: 5);
        ...
        [Test]
        public void GetInstrument_InitNoteFretPositionPropertiesCorrectly_1_3()
        {
            Note[,] result = _sut.GetInstrument(strings: 6, frets: 5);
        ...
        [Test]
        public void GetInstrument_InitNoteFretPositionPropertiesCorrectly_1_4()
        {
            Note[,] result = _sut.GetInstrument(strings: 6, frets: 5);
        ...
        [Test]
        public void GetInstrument_InitNoteFretPositionPropertiesCorrectly_2_0()
        {
            Note[,] result = _sut.GetInstrument(strings: 6, frets: 5);
        ...
        [Test]
        public void GetInstrument_InitNoteFretPositionPropertiesCorrectly_2_1()
        {
            Note[,] result = _sut.GetInstrument(strings: 6, frets: 5);
        ...
        [Test]
        public void GetInstrument_InitNoteFretPositionPropertiesCorrectly_2_2()
        {
            Note[,] result = _sut.GetInstrument(strings: 6, frets: 5);
        ...
        [Test]
        public void GetInstrument_InitNoteFretPositionPropertiesCorrectly_2_3()
        {
            Note[,] result = _sut.GetInstrument(strings: 6, frets: 5);
        ...
        [Test]
        public void GetInstrument_InitNoteFretPositionPropertiesCorrectly_2_4()
        {
            Note[,] result = _sut.GetInstrument(strings: 6, frets: 5);
        ...
        [Test]
        public void GetInstrument_InitNoteFretPositionPropertiesCorrectly_3_0()
        {
            Note[,] result = _sut.GetInstrument(strings: 6, frets: 5);
        ...
        [Test]
        public void GetInstrument_InitNoteFretPositionPropertiesCorrectly_3_1()
        {
            Note[,] result = _sut.GetInstrument(strings: 6, frets: 5);
        ...
        [Test]
        public void GetInstrument_InitNoteFretPositionPropertiesCorrectly_3_2()
        {
            Note[,] result = _sut.GetInstrument(strings: 6, frets: 5);
        ...
        [Test]
        public void GetInstrument_InitNoteFretPositionPropertiesCorrectly_3_3()
        {
            Note[,] result = _sut.GetInstrument(strings: 6, frets: 5);
        ...
        [Test]
        public void GetInstrument_InitNoteFretPositionPropertiesCorrectly_3_4()
        {
            Note[,] result = _sut.GetInstrument(strings: 6, frets: 5);
        ...
        [Test]
        public void GetInstrument_InitNoteFretPositionPropertiesCorrectly_4_0()
        {
            Note[,] result = _sut.GetInstrument(strings: 6, frets: 5);
        ...
        [Test]
        public void GetInstrument_InitNoteFretPositionPropertiesCorrectly_4_1()
        {
            Note[,] result = _sut.GetInstrument(strings: 6, frets: 5);
        ...
        [Test]
        public void GetInstrument_InitNoteFretPositionPropertiesCorrectly_4_2()
        {
            Note[,] result = _sut.GetInstrument(strings: 6, frets: 5);
        ...
        [Test]
        public void GetInstrument_InitNoteFretPositionPropertiesCorrectly_4_3()
        {
            Note[,] result = _sut.GetInstrument(strings: 6, frets: 5);
        ...
        [Test]
        public void GetInstrument_InitNoteFretPositionPropertiesCorrectly_4_4()
        {
            Note[,] result = _sut.GetInstrument(strings: 6, frets: 5);
        ...
        [Test]
        public void GetInstrument_InitNoteFretPositionPropertiesCorrectly_5_0()
        {
            Note[,] result = _sut.GetInstrument(strings: 6, frets: 5);
        ...
        [Test]
        public void GetInstrument_InitNoteFretPositionPropertiesCorrectly_5_1()
        {
            Note[,] result = _sut.GetInstrument(strings: 6, frets: 5);
        ...
        [Test]
        public void GetInstrument_InitNoteFretPositionPropertiesCorrectly_5_2()
        {
            Note[,] result = _sut.GetInstrument(strings: 6, frets: 5);
        ...
        [Test]
        public void GetInstrument_InitNoteFretPositionPropertiesCorrectly_5_3()
        {
            Note[,] result = _sut.GetInstrument(strings: 6, frets: 5);
        ...
        [Test]
        public void GetInstrument_InitNoteFretPositionPropertiesCorrectly_5_4()
        {
            Note[,] result = _sut.GetInstrument(strings: 6, frets: 5);
